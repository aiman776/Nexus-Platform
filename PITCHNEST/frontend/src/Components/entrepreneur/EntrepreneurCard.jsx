...
const EntrepreneurCard = ({ entrepreneur, showActions = true }) => {
    ...
    <Card hoverable className="transition-all duration-300 h-full" onClick={handleViewProfile}>
      <CardBody className="flex flex-col">
        <div className="flex items-start">
          <Avatar
            src={`https://ui-avatars.com/api/?name=${entrepreneur.name}&background=random`}
        ...
        <div className="mt-3 flex justify-between items-center">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{entrepreneur.stage}</p>
          </div>
        </div>
      </CardBody>
